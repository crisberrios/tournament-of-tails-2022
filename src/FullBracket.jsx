    ...
    <div className="round">
      ...
      <div className="full-bracket-container">
        ...
        <div className="elite-8">
          <BracketGame
            pet1={winnerFromGame(9)}
            pet2={winnerFromGame(5)}
            game={game(13)}
            top={120}
            setOverlayImage={setOverlayImage}
            setShowOverlay={setShowOverlay}
          />
          <BracketGame
            pet1={winnerFromGame(10)}
            pet2={winnerFromGame(6)}
            game={game(14)}
            top={340}
            setOverlayImage={setOverlayImage}
            setShowOverlay={setShowOverlay}
          />
          <BracketGame
            pet1={winnerFromGame(11)}
            pet2={winnerFromGame(7)}
            game={game(15)}
            top={576}
            setOverlayImage={setOverlayImage}
            setShowOverlay={setShowOverlay}
          />
          <BracketGame
            pet1={winnerFromGame(12)}
            pet2={winnerFromGame(8)}
            game={game(16)}
            top={805}
            setOverlayImage={setOverlayImage}
            setShowOverlay={setShowOverlay}
        ...
        <div className="final-4">
          <BracketGame
            pet1={winnerFromGame(13)}
            pet2={winnerFromGame(14)}
            game={game(17)}
            top={320}
            setOverlayImage={setOverlayImage}
            setShowOverlay={setShowOverlay}
          />
          <BracketGame
            pet1={winnerFromGame(15)}
            pet2={winnerFromGame(16)}
            game={game(18)}
            top={980}
            setOverlayImage={setOverlayImage}
            setShowOverlay={setShowOverlay}
        ...
        <div className="championship">
          <BracketGame
            pet1={winnerFromGame(17)}
            pet2={winnerFromGame(18)}
            game={game(19)}
            top={740}
            setOverlayImage={setOverlayImage}
            setShowOverlay={setShowOverlay}
