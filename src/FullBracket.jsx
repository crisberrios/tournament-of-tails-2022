    ...
    <div className="round">
      ...
      <div className="full-bracket-container">
        <div className="play-in left">
          ...
          <BracketGame pet1={pet(15)} pet2={pet(18)} game={game(3)} top={968} />
          <BracketGame pet1={pet(14)} pet2={pet(19)} game={game(4)} top={1388} />
        </div>
        ...
        <div className="elite-8">
          <BracketGame pet1={winnerFromGame(9)} pet2={winnerFromGame(5)} game={game(13)} top={114} />
        ...
        <div className="final-4">
          <BracketGame pet1={winnerFromGame(13)} pet2={winnerFromGame(14)} game={game(17)} top={318} />
